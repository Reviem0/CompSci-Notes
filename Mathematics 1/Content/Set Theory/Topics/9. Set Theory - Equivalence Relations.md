...
etc...
## Partition
A **partition** of a set is a way of dividing the set into distinct, non-overlapping subsets that together cover the entire set. Each subset in a **partition** is called a *part* or *block* of the **partit**
