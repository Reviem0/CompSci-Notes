...
- $R$ is **reflexive** as for $x \in X$, $x$ must have the same name as itself
	- $\forall x \in X,(x,x)\subseteq R$ exists
- $R$ is **symmetric** as for $x,y \in X$if $x$ has the same name as $y$ then $y$ must have the same name as $x$
- $R$ is **transitive** as if $x$ has the same name as $y$ and $y$ has 